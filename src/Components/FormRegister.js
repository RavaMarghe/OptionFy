...
class FormRegister extends React.Component {
  ...
  handleSubmit = (event) => {
    ...
    console.log({firstName, lastName, mail, tel, passWord, confirmPassWord, checked})
  }
  ...
  render() {
    return (
      <form ref={this._formRef} onSubmit={this.handleSubmit}>
        ...
        <p className="text-center pt-0 pb-3 "><span className="line-through">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span> Or <span className="line-through">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span></p>
