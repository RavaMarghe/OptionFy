              ...
              <div class="p-8 bg-gray-900 rounded">
                ...
                <ul class="mb-8 space-y-2">
                  <li class="flex items-center">
                    ...
                    <p class="font-medium text-gray-300"><strong>Daily options recommendations</strong></p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-300">Suggested strike prices for each symbol</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-300">8 recommended options strategies</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-300">Grading system for better options trading</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-300">Proprietary indicators</p>
                  </li>
                </ul>
                <button
                  type="submit"
...
{/* aggiungere risparmio */}
                ...
                <ul class="mb-8 space-y-2">
                  <li class="flex items-center">
                    ...
                    <p class="font-medium text-gray-300"><strong>Daily</strong> options recommendations</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
