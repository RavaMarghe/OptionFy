        ...
        <form className="w-96">
          ...
          <div className="mb-1 px-4 sm:mb-2">
            <input
              ...
              required
              type="text"
              className="bg-gray-900 flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
              id="firstName"
              name="firstName"
            />
          </div>
          ...
          <div className="mt-4 px-3 mb-2 sm:mb-4">
            ...
            <button
              className="inline-flex items-center justify-center w-full h-12 px-6 font-medium text-white bottone mt-2"
              type="button"
