...
export default function Privacy() {
  return (
    <div>
      <Header />
      <div className="bg-gradient-to-b from-violet-900 to-black text-white px-32">
        ...
        <ul className="list-disc ml-8">
          ...
          <li>
            ...
            this Agreement) refers to Optionsfy LLC, 7901 4th St N, STE 300 St.
            Petersburg , FL 33702.
          </li>
          <li>
        ...
        <h1 className="h1Size mt-8">Collecting and Using Your Personal Data</h1>
